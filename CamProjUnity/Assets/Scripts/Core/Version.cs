...
public static class Version 
{
	...
	// Also need to keep the version # in GameAnalytics settings in sync
	// Put a 'D' at the start to make a Dev version (with debug buttons)
	public static VersionNumber versionNumber = new VersionNumber("D0.0.0 (1)");
//	public static readonly System.DateTime buildTime = System.DateTime.Parse ("10/08/2015 11:15:00"); // Use format "MM/DD/YYYY HH:mm:ss"  MUST BE GMT AND MUST NOT BE LATER THAN CURRENT SERVER TIME 
